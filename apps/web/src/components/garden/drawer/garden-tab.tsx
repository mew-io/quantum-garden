        ...
        {signals ? (
          <div className="space-y-4">
            ...
            <div className="bg-[--wc-paper]/60 rounded p-3 space-y-2">
              ...
              <SignalBar label="Entropy" value={signals.entropy} color="bg-purple-500" description="Outcome uncertainty" />
              <SignalBar label="Dominance" value={signals.dominance} color="bg-cyan-500" description="Strongest outcome" />
              <SignalBar label="Spread" value={signals.spread} color="bg-blue-500" description="Outcome diversity" />
              <SignalBar label="Parity Bias" value={signals.parityBias} color="bg-amber-500" description="Even/odd balance" />
              <SignalBar label="Growth" value={signals.growth} color="bg-emerald-500" description="Lifecycle speed" />
              <SignalBar label="Certainty" value={signals.certainty} color="bg-yellow-500" description="Visual opacity" />
            </div>
            ...
            {traits && (
              <div className="bg-[--wc-paper]/60 rounded p-3 space-y-1.5 text-xs">
                ...
                {Object.entries(traits)
                  .filter(
                    ([key]) =>
                      !["glyphPattern", "colorPalette", "growthRate", "opacity", "quantumSignals"].includes(key)
                  )
                  .map(([key, value]) => (
                    <DetailRow
                      key={key}

...
export type BackgroundType = "clouds" | "parchment" | "plain";
...
> = {
  clouds: { label: "CLOUDS", backgroundColor: "#E0D8EE" },
...
export const BACKGROUND_ORDER: BackgroundType[] = ["clouds", "parchment", "plain"];

    ...
    <div className="flex flex-wrap items-center gap-4 p-4 bg-gray-100 border-b border-gray-200">
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          className="p-3 rounded bg-white text-gray-700 border border-gray-300 hover:bg-gray-50"
      ...
      <button
        onClick={goToGallery}
        className="px-4 py-2 text-sm rounded bg-gray-200 text-gray-700 hover:bg-gray-300 flex items-center gap-2"
      >

...
import { wcMoonlightHydrangea } from "./plants/watercolor/wc-moonlight-hydrangea";
...
import { wcStarlitLotus } from "./plants/watercolor/wc-starlit-lotus";
